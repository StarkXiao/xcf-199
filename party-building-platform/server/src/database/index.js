...
function initDatabase() {
  ...
  dbData.notices = [
    { id: 1, title: '关于做好2024年度党员民主评议工作的通知', content: '各党支部：根据《中国共产党章程》和上级党组织有关要求，现就做好2024年度党员民主评议工作通知如下：一、评议时间：2024年12月15日-31日；二、评议内容：党员的思想政治、学习情况、工作表现、组织纪律、先锋模范作用等；三、评议程序：学习教育、自我评价、民主评议、组织鉴定、表彰处理。', type: '工作通知', priority: 3, status: 'published', created_at: now, updated_at: now },
    { id: 2, title: '关于组织观看红色电影的通知', content: '为进一步深化党史学习教育，丰富党员精神文化生活，定于本周五（12月20日）下午2:30在机关一楼大会议室播放红色电影《长津湖》。请各党支部组织党员准时观看。', type: '活动通知', priority: 2, status: 'published', created_at: now, updated_at: now },
    { id: 3, title: '关于开展党风廉政建设专项检查的通知', content: '为深入推进全面从严治党，加强党风廉政建设，经研究决定，在全系统开展党风廉政建设专项检查。检查时间：2024年12月25日-31日；检查内容：落实党风廉政建设责任制、中央八项规定精神执行情况等。请各单位做好自查自纠工作。', type: '廉政通知', priority: 3, status: 'published', created_at: now, updated_at: now },
    { id: 4, title: '关于举办"学习强国"学习标兵评选活动的通知', content: '为充分调动广大党员使用"学习强国"学习平台的积极性和主动性，营造"比学赶超"的浓厚学习氛围，决定在全系统开展"学习强国"学习标兵评选活动。评选标准：以平台积分为主要依据，结合学习活跃度等。请各党支部积极推荐。', type: '评优通知', priority: 1, status: 'published', created_at: now, updated_at: now },
    { id: 5, title: '关于做好2025年元旦春节期间有关工作的通知', content: '各党支部：2025年元旦、春节将至，现就做好节日期间有关工作通知如下：一、严格落实中央八项规定精神，坚决杜绝"节日腐败"；二、做好节日期间值班值守工作；三、关心关爱困难党员和群众；四、抓好安全生产和应急管理工作。', type: '节日通知', priority: 2, status: 'published', created_at: now, updated_at: now },
    { id: 6, title: '关于党支部书记培训班的补充通知', content: '原定于12月20日举办的党支部书记培训班，因工作安排调整，时间改为12月26日-27日，地点不变。请各党支部书记提前安排好工作，准时参加培训。', type: '培训通知', priority: 2, status: 'published', created_at: now, updated_at: now }
  ];
...
function paginate(table, { page = 1, page_size = 10, predicate, sortBy, sortOrder = 'desc' }) {
